export default function HowToGetStartedItem() {
  return (
    <div className=" relative font-raleWay    w-[85vw]  h-[250px] sm:w-[36vw] sm:h-[300px] sm:max-w-[450px] 2xl:max-w-[470px]">
      ...
      {/* ShadowPart */}
      <div className="w-[78vw] sm:w-[33vw] min-h-[220px] xl:max-w-[420px] sm:min-h-[250px] sm:max-w-[400px]  rounded-[33px] top-[27px] sm:top-[33px] absolute z-0 left-0 bg-black "></div>
    </div>
  );
}
